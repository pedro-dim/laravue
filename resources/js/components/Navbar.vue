<template>
  ...
  <header class="bg-gray-100 min-h-screen">
    <nav class="bg-white shadow-md">
      <div
        class="container mx-auto sm:flex items-center justify-between sm:py-4 sm:px-3"
      >
        <div class="py- ms:py-0 px-4">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="w-10 h-10 text-purple-600"
            viewBox="0 0 24 24"
        ...
        <div>
          <ul class="space-x-2 border-b-2 border-t-2 py-2 space-y-2">
            <li
              class="sm:inline-block text-sm ml-2 font-semibold text-grau-700 hover:text-indigo-600 tracking-wide"
            >
              <a href="#">Products</a>
            </li>
            <li
              class="sm:inline-block text-sm font-semibold text-grau-700 hover:text-indigo-600 tracking-wide"
            >
...
const message = ref("String text message");
</script>
